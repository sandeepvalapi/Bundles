...
public class TestFtl {
	...
	static {
		...
		// Please use this. To make it backward compatible. Please visit here
		// for more info:
	...
	/*
	 * TODO: Use dynamic template, params object create individual mappers for
	 * each and every template - NTD
	 */
